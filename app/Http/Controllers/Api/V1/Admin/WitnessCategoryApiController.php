...
use App\Http\Resources\Admin\WitnessCategoryResource;
use App\Models\WitnessCategory;
use Gate;
use Illuminate\Http\Request;
use Symfony\Component\HttpFoundation\Response;

class WitnessCategoryApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('witness_category_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new WitnessCategoryResource(WitnessCategory::all());
    }
    ...
    public function store(StoreWitnessCategoryRequest $request)
    {
        ...
        return (new WitnessCategoryResource($witnessCategory))
            ->response()
