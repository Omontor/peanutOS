...
class DocumenationChapterController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.documenationChapters.index', compact('documenationChapters'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.documenationChapters.create', compact('project_documentations'));
    }
    ...
    public function store(StoreDocumenationChapterRequest $request)
    {
        ...
        return redirect()->route('admin.documenation-chapters.index');
    }
    ...
    public function edit(DocumenationChapter $documenationChapter)
    {
        ...
        return view('admin.documenationChapters.edit', compact('documenationChapter', 'project_documentations'));
    }
    ...
    public function show(DocumenationChapter $documenationChapter)
    {
        ...
        return view('admin.documenationChapters.show', compact('documenationChapter'));
    }
