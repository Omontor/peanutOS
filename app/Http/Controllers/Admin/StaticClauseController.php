...
class StaticClauseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.staticClauses.index', compact('staticClauses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.staticClauses.create');
    }
    ...
    public function store(StoreStaticClauseRequest $request)
    {
        ...
        return redirect()->route('admin.static-clauses.index');
    }
    ...
    public function edit(StaticClause $staticClause)
    {
        ...
        return view('admin.staticClauses.edit', compact('staticClause'));
    }
    ...
    public function show(StaticClause $staticClause)
    {
        ...
        return view('admin.staticClauses.show', compact('staticClause'));
    }
