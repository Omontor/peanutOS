...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Product::with(['client'])->select(sprintf('%s.*', (new Product())->table));
        ...
        $photo->thumbnail
            ...
            $table->rawColumns(['actions', 'placeholder', 'logo', 'client']);
        ...
        return view('admin.products.index', compact('clients'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('admin.products.edit', compact('clients', 'product'));
    }
