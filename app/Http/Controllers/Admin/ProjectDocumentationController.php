...
class ProjectDocumentationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.projectDocumentations.index', compact('projectDocumentations'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.projectDocumentations.create', compact('projects'));
    }
    ...
    public function store(StoreProjectDocumentationRequest $request)
    {
        ...
        return redirect()->route('admin.project-documentations.index');
    }
    ...
    public function edit(ProjectDocumentation $projectDocumentation)
    {
        ...
        return view('admin.projectDocumentations.edit', compact('projectDocumentation', 'projects'));
    }
    ...
    public function show(ProjectDocumentation $projectDocumentation)
    {
        ...
        return view('admin.projectDocumentations.show', compact('projectDocumentation'));
    }
