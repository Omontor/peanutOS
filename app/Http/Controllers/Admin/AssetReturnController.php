...
class AssetReturnController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.assetReturns.index', compact('assetReturns'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.assetReturns.create', compact('rents'));
    }
    ...
    public function store(StoreAssetReturnRequest $request)
    {
        ...
        return redirect()->route('admin.asset-returns.index');
    }
    ...
    public function edit(AssetReturn $assetReturn)
    {
        ...
        return view('admin.assetReturns.edit', compact('assetReturn', 'rents'));
    }
    ...
    public function show(AssetReturn $assetReturn)
    {
        ...
        return view('admin.assetReturns.show', compact('assetReturn'));
    }
