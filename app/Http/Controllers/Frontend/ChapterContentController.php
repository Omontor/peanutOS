...
class ChapterContentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.chapterContents.index', compact('chapterContents'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.chapterContents.create', compact('chapters'));
    }
    ...
    public function store(StoreChapterContentRequest $request)
    {
        ...
        return redirect()->route('frontend.chapter-contents.index');
    }
    ...
    public function edit(ChapterContent $chapterContent)
    {
        ...
        return view('frontend.chapterContents.edit', compact('chapterContent', 'chapters'));
    }
    ...
    public function show(ChapterContent $chapterContent)
    {
        ...
        return view('frontend.chapterContents.show', compact('chapterContent'));
    }
