...
class DynamicClauseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.dynamicClauses.index', compact('dynamicClauses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.dynamicClauses.create');
    }
    ...
    public function store(StoreDynamicClauseRequest $request)
    {
        ...
        return redirect()->route('frontend.dynamic-clauses.index');
    }
    ...
    public function edit(DynamicClause $dynamicClause)
    {
        ...
        return view('frontend.dynamicClauses.edit', compact('dynamicClause'));
    }
    ...
    public function show(DynamicClause $dynamicClause)
    {
        ...
        return view('frontend.dynamicClauses.show', compact('dynamicClause'));
    }
