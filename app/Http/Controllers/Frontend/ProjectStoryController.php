...
class ProjectStoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.projectStories.index', compact('projectStories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.projectStories.create', compact('projects'));
    }
    ...
    public function store(StoreProjectStoryRequest $request)
    {
        ...
        return redirect()->route('frontend.project-stories.index');
    }
    ...
    public function edit(ProjectStory $projectStory)
    {
        ...
        return view('frontend.projectStories.edit', compact('projectStory', 'projects'));
    }
    ...
    public function show(ProjectStory $projectStory)
    {
        ...
        return view('frontend.projectStories.show', compact('projectStory'));
    }
