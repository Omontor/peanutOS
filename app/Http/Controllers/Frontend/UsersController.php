...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.users.index', compact('roles', 'teams', 'users'));
    }
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'team', 'userClients', 'clientRents', 'clientQuotations', 'clientApprovals', 'leadManagements', 'reporterEpics', 'asigneeTasks', 'userUserAlerts', 'asigneesEpics');
