...
class ClientEvaluationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.clientEvaluations.index', compact('clientEvaluations'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.clientEvaluations.create', compact('clients'));
    }
    ...
    public function store(StoreClientEvaluationRequest $request)
    {
        ...
        return redirect()->route('frontend.client-evaluations.index');
    }
    ...
    public function edit(ClientEvaluation $clientEvaluation)
    {
        ...
        return view('frontend.clientEvaluations.edit', compact('clientEvaluation', 'clients'));
    }
    ...
    public function show(ClientEvaluation $clientEvaluation)
    {
        ...
        return view('frontend.clientEvaluations.show', compact('clientEvaluation'));
    }
