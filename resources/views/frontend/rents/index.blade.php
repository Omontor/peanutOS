        ...
        <div class="col-md-12">
            @can('rent_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.rents.create') }}">
                            ...
                            <tbody>
                                @foreach($rents as $key => $rent)
                                    <tr data-entry-id="{{ $rent->id }}">
                                        ...
                                        <td>
                                            @can('rent_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.rents.show', $rent->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('rent_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.rents.edit', $rent->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('rent_delete')
                                                <form action="{{ route('frontend.rents.destroy', $rent->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('rent_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.rents.massDestroy') }}",
