        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.clientEvaluation.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.client-evaluations.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rating" id="rating" value="{{ old('rating', '10.0') }}" step="0.01" required max="10">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="observations" id="observations">{!! old('observations') !!}</textarea>
