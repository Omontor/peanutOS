                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assets.update", [$asset->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cost" id="cost" value="{{ old('cost', $asset->cost) }}" step="0.01">
                            @if($errors->has('cost'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cost') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="day_price" id="day_price" value="{{ old('day_price', $asset->day_price) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="week_price" id="week_price" value="{{ old('week_price', $asset->week_price) }}" step="0.01">
