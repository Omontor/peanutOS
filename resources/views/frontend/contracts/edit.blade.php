                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contracts.update", [$contract->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="contract_date" id="contract_date" value="{{ old('contract_date', $contract->contract_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="contract_deadline" id="contract_deadline" value="{{ old('contract_deadline', $contract->contract_deadline) }}">
