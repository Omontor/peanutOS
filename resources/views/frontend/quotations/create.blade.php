    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.quotations.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="clauses[]" id="clauses" multiple>
                                @foreach($clauses as $id => $clause)
                                    <option value="{{ $id }}" {{ in_array($id, old('clauses', [])) ? 'selected' : '' }}>{{ $clause }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="validity" id="validity" value="{{ old('validity', '30') }}" step="1">
