                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($basic_datas as $key => $item)
                    ...
                    <td>
                        <select class="search">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach($static_clauses as $key => $item)
                    ...
                    <td>
                        <select class="search">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach($dynamic_clauses as $key => $item)
                                <option value="{{ $item->title }}">{{ $item->title }}</option>
                            @endforeach
                        </select>
                    </td>
...
{ data: 'contract_deadline', name: 'contract_deadline' },
{ data: 'from_name', name: 'from.name' },
{ data: 'client_name', name: 'client.name' },
{ data: 'static_clauses', name: 'static_clauses.title' },
{ data: 'dynamic_clauses', name: 'dynamic_clauses.title' },
