    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-leadManagements">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($managements as $key => $management)
                            <tr data-entry-id="{{ $management->id }}">
                                ...
                                <td>
                                    @can('management_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.managements.show', $management->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
...
@endcan
  ...
  let table = $('.datatable-leadManagements:not(.ajaxTable)').DataTable({ buttons: dtButtons })
