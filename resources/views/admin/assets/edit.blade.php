    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets.update", [$asset->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('front_photo') ? 'is-invalid' : '' }}" id="front_photo-dropzone">
                </div>
                @if($errors->has('front_photo'))
                    <span class="text-danger">{{ $errors->first('front_photo') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('side_photo') ? 'is-invalid' : '' }}" id="side_photo-dropzone">
                </div>
                @if($errors->has('side_photo'))
                    <span class="text-danger">{{ $errors->first('side_photo') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('quarter_photo') ? 'is-invalid' : '' }}" id="quarter_photo-dropzone">
                </div>
                @if($errors->has('quarter_photo'))
                    <span class="text-danger">{{ $errors->first('quarter_photo') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost') ? 'is-invalid' : '' }}" type="number" name="cost" id="cost" value="{{ old('cost', $asset->cost) }}" step="0.01">
                @if($errors->has('cost'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('day_price') ? 'is-invalid' : '' }}" type="number" name="day_price" id="day_price" value="{{ old('day_price', $asset->day_price) }}" step="0.01" required>
                @if($errors->has('day_price'))
                    <span class="text-danger">{{ $errors->first('day_price') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('week_price') ? 'is-invalid' : '' }}" type="number" name="week_price" id="week_price" value="{{ old('week_price', $asset->week_price) }}" step="0.01">
                @if($errors->has('week_price'))
                    <span class="text-danger">{{ $errors->first('week_price') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $asset->status) }}" step="1">
