    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.assets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('day_price') ? 'is-invalid' : '' }}" type="number" name="day_price" id="day_price" value="{{ old('day_price', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('week_price') ? 'is-invalid' : '' }}" type="number" name="week_price" id="week_price" value="{{ old('week_price', '') }}" step="0.01">
