    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rents.update", [$rent->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('from') ? 'is-invalid' : '' }}" type="text" name="from" id="from" value="{{ old('from', $rent->from) }}" required>
                @if($errors->has('from'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('to') ? 'is-invalid' : '' }}" type="text" name="to" id="to" value="{{ old('to', $rent->to) }}" required>
                @if($errors->has('to'))
