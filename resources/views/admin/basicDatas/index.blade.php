...
@can('basic_data_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.basic-datas.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-BasicData">
            <thead>
                <tr>
                    <th width="10">
...
@can('basic_data_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.basic-datas.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.basic-datas.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-BasicData').DataTable(dtOverrideGlobals);
