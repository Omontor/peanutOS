                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('basic_data_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.basic-datas.index') }}">
                                    ...
                                    @can('project_story_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.project-stories.index') }}">
                                    ...
                                    @can('quotation_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.quotations.index') }}">
                                    ...
                                    @endcan
                                    @can('approval_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.approvals.index') }}">
                                    ...
                                    @can('client_evaluation_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.client-evaluations.index') }}">
                                    ...
                                    @can('witness_category_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.witness-categories.index') }}">
                                            {{ trans('cruds.witnessCategory.title') }}
                                        </a>
                                    @endcan
                                    @can('event_witness_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.event-witnesses.index') }}">
                                    ...
                                    @can('project_documentation_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.project-documentations.index') }}">
                                            {{ trans('cruds.projectDocumentation.title') }}
                                        </a>
                                    @endcan
                                    @can('documenation_chapter_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.documenation-chapters.index') }}">
                                            {{ trans('cruds.documenationChapter.title') }}
                                        </a>
                                    @endcan
                                    @can('chapter_content_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.chapter-contents.index') }}">
